...
export const useSpeechSynthesis = (
  ...
  const [rateState, setRateState] = useState<number>(() => {
    try {
      const saved = localStorage.getItem("story-spark-narration-rate");
  ...
  const [pitchState, setPitchState] = useState<number>(() => {
    try {
      const saved = localStorage.getItem("story-spark-narration-pitch");
      return saved ? Number(saved) : 1;
    } catch {
      return 1;
    }
  ...
  const [volumeState, setVolumeState] = useState<number>(() => {
    try {
      const saved = localStorage.getItem("story-spark-narration-volume");
      return saved ? Number(saved) : 1;
    } catch {
      return 1;
    }
  ...
  const [selectedVoiceId, setSelectedVoiceId] = useState<string>(() => {
    try {
      return localStorage.getItem("story-spark-narration-voice-id") ?? "";
    } catch {
      return "";
    }
  });
  const [selectedLanguage, setSelectedLanguage] = useState<string>(() => {
    try {
      return localStorage.getItem("story-spark-narration-lang") ?? "en-US";
    } catch {
      return "en-US";
    }
  });
  ...
  useEffect(() => {
    try {
      localStorage.setItem("story-spark-narration-rate", rateState.toString());
    } catch (e) {
      console.warn(e);
    }
  }, [rateState]);
  ...
  useEffect(() => {
    try {
      localStorage.setItem("story-spark-narration-pitch", pitchState.toString());
    } catch (e) {
      console.warn(e);
    }
  }, [pitchState]);
  ...
  useEffect(() => {
    try {
      localStorage.setItem("story-spark-narration-volume", volumeState.toString());
    } catch (e) {
      console.warn(e);
    }
  }, [volumeState]);
  ...
  useEffect(() => {
    try {
      if (selectedVoiceId) {
        localStorage.setItem("story-spark-narration-voice-id", selectedVoiceId);
      }
    } catch (e) {
      console.warn(e);
    }
  ...
  useEffect(() => {
    try {
      if (selectedLanguage) {
        localStorage.setItem("story-spark-narration-lang", selectedLanguage);
      }
    } catch (e) {
      console.warn(e);
    }
